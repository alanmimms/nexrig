# L1L2 series config in rx preselector
    ...
    L1  L2  L1L2
     0   0    0     Neither L in circuit (L1 hot gnd, L2 hot gnd)
     0   0    1     UNUSED: L1 hot and L2 cold tied together (!)
     0   1    0     L2
     0   1    1     L1++L2
     1   0    0     L1 in circuit, L2 hot gnd
	 1   0    1     UNUSED: L1 in circuit, L2 cold gnd
     1   1    0     L1||L2
	 1   1    1     UNUSED: L1 in circuit, L2 cold gnd
