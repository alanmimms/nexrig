...
## Capacitor Values
The capacitor bank has 11 capacitors, with ten (C0..C9, 4pF..2048pF) arranged in a binary weighted configuration except for the highest valued one: C10=2.2nF. These may be selected in any paralleled combination by the STM32 firmware for general coverage HF band tuning.
## Inductor Values (5 unique configurations)
The inductors are similarly arranged in a bank of four values, but two of these may be arranged in series and any of the inductors may be arranged in parallel to combine to get the values needed for the general coverage HF band tuning.
...
|Band|Freq_MHz|L_Config|L_eff_nH|C_min_pF|C_max_pF|Step_kHz_per_4pF|
|---|---|---|---|---|---|---|
|0|0.8-1.5|L1+L2_series|10900|2200*|4200*|2|
|1|1.0-2.2|L1|8200|900|2800*|3|
|2|2.0-3.8|L1\|L2|2030|860|1560|8|
|3|3.5-6.0|L2|2700|260|760|12|
|4|5.5-9.5|L3|820|340|1020|25|
|5|9-15|L2\|L3|621|180|500|35|
|6|14-21|L4|270|210|480|45|
|7|20-30|L3\|L4|203|140|310|48|

*Requires 2.2nF switchable cap in parallel with binary bank

## Unique L Configurations

1. L1+L2 series: 10.9µH
2. L1: 8.2µH
3. L1||L2: 2.03µH
4. L2: 2.7µH
5. L3: 820nH
