...
def design_real_chebyshev_bpf(f_low_mhz, f_high_mhz, band_name):
    ...
    # Apply frequency corrections based on previous simulation results
    # Previous results: 40m peak at 7.06 (target 7.15), 20m at ~13.8 (target 14.17), 10m at ~28.5 (target 28.84)
    if band_name == '20m':
        freq_correction = 1.03  # Need to shift UP slightly
    elif band_name == '10m':  
        freq_correction = 1.02  # Need to shift UP slightly
    else:
        freq_correction = 1.01  # 40m needs tiny adjustment
