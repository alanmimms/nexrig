...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB1     ------> ADC1_INP5
    */
    GPIO_InitStruct.Pin = V12_SENSE_Pin|SSB_I_Pin|SSB_Q_Pin|SWR_SENSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = PRE_POWER_SENSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(PRE_POWER_SENSE_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = PA_POWER_SENSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(PA_POWER_SENSE_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PA5     ------> ADC2_INP19
    */
    GPIO_InitStruct.Pin = SSB_I_Pin|SSB_Q_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_INP5
    */
    HAL_GPIO_DeInit(GPIOA, V12_SENSE_Pin|SSB_I_Pin|SSB_Q_Pin|SWR_SENSE_Pin);

    HAL_GPIO_DeInit(PRE_POWER_SENSE_GPIO_Port, PRE_POWER_SENSE_Pin);

    HAL_GPIO_DeInit(PA_POWER_SENSE_GPIO_Port, PA_POWER_SENSE_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PA5     ------> ADC2_INP19
    */
    HAL_GPIO_DeInit(GPIOA, SSB_I_Pin|SSB_Q_Pin);
